...
| 6 | public void Login(LoginCallback callback = null, List< string > permissionList = null, bool needGuid = true) | 一般登录 | √ | |
| 7 | public void StrictLogin(LoginCallback callback = null, List< string > permissionList = null, bool needGuid = true) | 严格登录 | √ | |
...
| 18 | public bool IsChannelAppInstalled() | 是否安装渠道应用 | × | Facebook 登录可以不需要 App |
| 19 | public bool IsChannelSupportApi() | 应用API版本是否可用 | × | Facebook 登录可以不需要 App |
